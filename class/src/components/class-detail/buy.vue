  ...
  <div class="buy-info">
    ...
    <div class="buy-right">
      ...
      <p class="buy-class-info">
        <img src="../../../static/images/detail/icon-num.png" alt="" width="16" height="16">
        <span>{{lesson_info.lesson_num}}</span>
        <img src="../../../static/images/detail/icon-time.png" alt="" width="16" height="16">
        <span>{{lesson_info.lesson_time}}</span>
        <img src="../../../static/images/detail/icon-per.png" alt="" width="16" height="16">
...
export default {
  ...
  data () {
    return {
      share: {
        src: '../../static/images/detail/share1.png',
        type: false
      },
      like: {
        src: '../../static/images/detail/like1.png', // 图片路径
        type: false // 是否被选中 默认未选中
      },
      qq: '../../static/images/detail/icon-qq1.png', // qq图片切换
      wx: '../../static/images/detail/icon-wx1.png',
      wb: '../../static/images/detail/icon-wb1.png'
    }
  },
  methods: {
    // 分享
    pic_change (bool) {
      var that = this
      if (bool) {
        that.share.src = '../../static/images/detail/share2.png'
        that.share.type = true
      } else {
        that.share.src = '../../static/images/detail/share1.png'
    ...
    like_change () {
      ...
      if (that.like.type) {
        that.like.src = '../../static/images/detail/like2.png'
        layer.msg('收藏成功', {
          time: 2000
        })
      } else {
        that.like.src = '../../static/images/detail/like1.png'
        layer.msg('收藏已取消', {
          time: 2000
        })
      }
    ...
    qq_change (bool) {
      var that = this
      if (bool) {
        that.qq = '../../static/images/detail/icon-qq2.png'
      } else {
        that.qq = '../../static/images/detail/icon-qq1.png'
      }
    },
    wx_change (bool) {
      var that = this
      if (bool) {
        that.wx = '../../static/images/detail/icon-wx2.png'
      } else {
        that.wx = '../../static/images/detail/icon-wx1.png'
      }
    },
    wb_change (bool) {
      var that = this
      if (bool) {
        that.wb = '../../static/images/detail/icon-wb2.png'
      } else {
        that.wb = '../../static/images/detail/icon-wb1.png'
      }
    }
  },
  mounted () {
  // 是否已经收藏
    ...
    if (buy_info.Islike) {
      that.like = {
        src: '../../static/images/detail/like2.png', // 图片路径
