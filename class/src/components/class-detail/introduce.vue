    ...
    <ul class="introduce-left">
      ...
      <li class="detail-con">
        ...
        <div class="li-con">
          ...
          <p class="li-detail" v-for="item in lesson_info.lesson_position.detail">
      ...
      <li class="detail-con">
        ...
        <div class="li-con">
          <p class="li-detail" v-for="item in lesson_info.lesson_youshi">
            <span class="p-left">◇</span>
            <span class="p-right">{{item}}</span>
          </p>
        </div>
      ...
      <li class="detail-con">
        ...
        <div class="li-con">
          <p class="li-detail" v-for="item in lesson_info.lesson_get">
            <span class="p-left">◇</span>
            <span class="p-right">{{item}}</span>
          </p>
        </div>
      ...
      <li class="detail-con">
        ...
        <div class="li-con">
          ...
          <p class="li-detail" v-for="item in lesson_info.lesson_target.detail">
            <span class="p-left">◇</span>
            <span class="p-right">{{item}}</span>
          </p>
        </div>
      ...
      <li class="detail-con">
        ...
        <div class="li-con">
          <div class="li-con-left">
            <p class="li-detail" v-for="item in stu_left">
              <span class="p-left">◇</span>
              <span class="p-right">{{item}}</span>
            </p>
          </div>
          <div class="li-con-right">
            <p class="li-detail" v-for="item in stu_right">
              <span class="p-left">◇</span>
              <span class="p-right">{{item}}</span>
            </p>
          </div>
        ...
        <div class="li-con">
          <div class="li-con-left">
            <ul class="outline-list">
              <li v-for="item  in outline_left">
                <p class="outline-tit">{{item.tit}} </p>
                <p class="outline-con" v-for="it in item.detail"> {{it}}</p>
              </li>
            </ul>
          </div>
          <div class="li-con-right">
            <ul class="outline-list">
              <li v-for="item  in outline_right">
                <p class="outline-tit">{{item.tit}} </p>
                <p class="outline-con" v-for="it in item.detail"> {{it}}</p>
              </li>
            </ul>
    ...
    <div class="introduce-right">
      <ul class="teacher_introduce">
        <li class="abotu-tacher">
          ...
          <div class="teacher_tips" v-for="item in teacher_info.tips">{{ item }}</div>
        </li>
        <li>
          <p class="li-tit">主讲课程</p>
          <div class="about-lesson" v-for="(item,index) in teacher_info.about_lesson">
      ...
      <div class="teacher_project">
       ...
       <div class="project_list" v-for="(item,index) in teacher_info.about_project">
        ...
        <div class="recommend-lesson">
          ...
          <div class="about-lesson" v-for="(item,index) in recommend_lesson">
            <img :src="item.cover" alt="">
            <p class="about-tit">{{item.tit}}</p>
          </div>
        </div>
