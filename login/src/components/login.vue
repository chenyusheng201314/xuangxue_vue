      ...
      <div class="login-type">
        <div class="login-type-left">
          <span class="box" @click="change_remember">
            <img src="../../static/images/icon-gou.png" v-show="remember_type" alt="" width="12">
          </span>
...
export default {
  ...
  data () {
    return {
      login_tab: {
        number_img: '../../static/images/number-login1.png',
        phone_img: '../../static/images/phone-login.png'
      },
      tab_type: 1, // 1表示账户登录  2表示手机登录  默认账户登录
      wx_img: '../../static/images/icon-wx1.png',
      qq_img: '../../static/images/icon-qq1.png',
  ...
  methods: {
    ...
    wx_change (bool) {
      var that = this
      if (bool) {
        that.wx_img = '../../static/images/icon-wx2.png'
      } else {
        that.wx_img = '../../static/images/icon-wx1.png'
      }
    },
    // 鼠标滑过qq
    qq_change (bool) {
      var that = this
      if (bool) {
        that.qq_img = '../../static/images/icon-qq2.png'
      } else {
        that.qq_img = '../../static/images/icon-qq1.png'
      }
    },
    //  十天免登陆切换
    change_remember () {
  ...
  watch: {
    tab_type () {
      var that = this
      if (that.tab_type === 1) {
        that.login_tab.number_img = '../../static/images/number-login1.png'
        that.login_tab.phone_img = '../../static/images/phone-login.png'
      } else if (that.tab_type === 2) {
        that.login_tab.phone_img = '../../static/images/phone-login1.png'
        that.login_tab.number_img = '../../static/images/number-login.png'
      }
    }
  }
}
